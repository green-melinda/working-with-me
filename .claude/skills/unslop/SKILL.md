...
13. **Em dash overuse.** No em dashes in writing you generate. Use periods or commas only (no parentheses, no en dashes, no hyphen-as-dash substitutes). Em dashes are an AI tell, and reaching for parentheses instead just trades one tell for another. If a thought needs separation, end the sentence or use a comma. This applies to new writing only. Do not strip em dashes out of prose Melinda wrote herself unless she asks. Her em dashes read as her, and the point of this rule is to sound like a person, not to enforce a house style on a human.
