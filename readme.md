...
- `design-system/civic-ink-type-rule-v1.7.md` — the type rule, versioned separately
- `UX-PRINCIPLES.md` — positions on users, problems and craft, specific enough to argue with
